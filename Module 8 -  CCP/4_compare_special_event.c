 ...
 *
 * Use ccp2 (compare mode) as the period register for timer 1
 */
...
#define LED PORTAbits.RA0 // LED is not yet connected to CCP2
...
//    T3CONbits.T3CCP1 = 0; //Timer 1 is the capture/compare clock source for  CCP1
    ...
    CCP2CONbits.CCP2M = 0b1011; // compare mode, trigger special even (reset timer 1)
    ...
    // LED is connected to RA0 and is on when LED = 1
    ADCON1 = 0x0F;
    TRISAbits.RA0 = 0;
    LED = 0;
